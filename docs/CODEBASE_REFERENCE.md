...
- Free download no longer immediately saves the export from the compact panel. It first opens a shared modal explaining the free package value, included features, generated page URLs/purposes, optional hosting/custom-page CTAs, and then shows the real buyer-facing `Download your site for free` button.
