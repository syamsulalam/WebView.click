...
export function siteSummaryFromJson(deps: Pick<SiteStorageDeps, "asString">, parsed: Record<string, unknown>, businessId: string) {
  ...
  return {
    ...
    designSystemVersion: asString(meta.designSystemVersion),
    lastDesignUpgradeAt: asString(meta.lastDesignUpgradeAt),
    lastPremiumCopyUpgradeAt: asString(meta.lastPremiumCopyUpgradeAt),
    premiumUpgradeComplete: meta.premiumUpgradeComplete === true,
    premiumUpgradeCompletedAt: asString(meta.premiumUpgradeCompletedAt),
    lastUpgradeMode: asString(meta.lastUpgradeMode),
